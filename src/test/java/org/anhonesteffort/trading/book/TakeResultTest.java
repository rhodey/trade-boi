...
public class TakeResultTest extends BaseTest {
  ...
  public void testEmpty() {
    ...
    assertTrue(RESULT.getTaker().getPrice() == 10);
    assertTrue(RESULT.getTaker().getSize()  == 20);
  ...
  public void testAskMakers() {
    ...
    assertTrue(RESULT.getTakeSize()      == TAKE_SIZE);
    assertTrue(RESULT.getTakeValue()     == TAKE_VALUE);
    assertTrue(RESULT.getMakers().size() == 3);

    RESULT.clearMakerValueRemoved();

    assertTrue(ASK0.getValueRemoved() == 0);
    assertTrue(ASK1.getValueRemoved() == 0);
    assertTrue(ASK2.getValueRemoved() == 0);
  }
  ...
  public void testBidMakers() {
    ...
    assertTrue(BID0.getValueRemoved() == 0);
    assertTrue(BID1.getValueRemoved() == 0);
    assertTrue(BID2.getValueRemoved() == 0);
  }
